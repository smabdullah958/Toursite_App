...
//         type="button"
//         onClick={() => remove(index)}
//         className="bg-gradient-to-r from-red-100 to-red-200 text-white px-3 py-3 rounded-lg hover:from-red-300 hover:to-red-400 duration-300 transition shadow-lg"
//       >
//         ❌
//       </button>
//       )}
