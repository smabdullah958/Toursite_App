...
if(displayResult.length===0){
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-amber-50 to-yellow-100 relative overflow-hidden">
      ...
      <div className="max-w-full mx-auto px-6 py-5 md:py-10 relative z-10">
        {/* Page Title */}
        <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-amber-900 via-amber-800 to-amber-900 bg-clip-text text-transparent text-center mb-5 tracking-tight drop-shadow-sm">
          All Destination Bookings
        </h1>
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex flex-wrap gap-2 text-amber-700 text-sm md:text-base mt-2">
                  <span className="bg-amber-100/80 text-amber-800 px-3 py-1 rounded-full shadow-sm border border-amber-200">Days: 
                  {booking.Days||1}</span>

                  <span className="bg-yellow-100/80 text-amber-800 px-3 py-1 rounded-full shadow-sm border border-amber-200">Adults: {booking.NumberOfAdultChild}</span>

                  <span className="bg-amber-100/80 text-amber-800 px-3 py-1 rounded-full shadow-sm border border-amber-200">Children: {booking.NumberOfNoneAdultChild || 0}</span>

                  <span className="bg-yellow-100/80 text-amber-800 px-3 py-1 rounded-full shadow-sm border border-amber-200">Booking Date: {booking.Date}</span>

                </div>
              <div className="flex flex-wrap md:justify-between justify-normal">
                <Link href={`GetDestinationBooking/${booking._id}`} className="px-6 py-2 rounded-xl bg-gradient-to-r from-amber-600 to-yellow-600 hover:from-amber-700 hover:to-yellow-700 text-white font-semibold shadow-lg  transition-all duration-500 transform hover:scale-105 active:scale-95 mr-5 opacity-100 mt-3">View Detail</Link>
