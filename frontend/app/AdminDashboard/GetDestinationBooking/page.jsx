...
if(displayResult.length===0){
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-amber-50 to-yellow-100 relative overflow-x-hidden overflow-hidden">
    ...
    {/* Desert Background Pattern */}
      ...
      <div className="max-w-full mx-auto px-6 py-5 md:py-10 relative z-10">
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex flex-wrap md:justify-between justify-normal">
                  <Link href={`GetDestinationBooking/${booking._id}`} className="px-6 py-2 rounded-xl bg-gradient-to-r from-amber-600 to-yellow-600 hover:from-amber-700 hover:to-yellow-700 text-white font-semibold shadow-lg  transition-all duration-500 transform hover:scale-105 active:scale-95 mr-5 opacity-100 mt-3">
                    View Detail
                  </Link>
        ...
        {/* Load More Button */}
        { !isSearched &&  displayResult?.length >= 20 &&  hasMore && !Loading && (
