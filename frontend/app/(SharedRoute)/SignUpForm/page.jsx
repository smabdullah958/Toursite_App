...
useEffect(()=>{
 ...
 <div className="w-full sm:max-w-md p-8 bg-white shadow-2xl rounded-2xl 2xl:w-[80vw] 2xl:h-[50vh]">
      ...
      <p className="text-red-500 text-sm mt-1 2xl:text-3xl" >{errors.Name?.message}</p>
          ...
          {/* Email */}
          <div>
        <label className="block text-sm font-medium text-gray-700 2xl:text-3xl 2xl:my-4 ">
              Email Address
            </label>
            <input
              type="email"
          ...
          {/* Password */}
          <div>
            <label className="block text-sm font-medium text-gray-700 2xl:text-2xl 2xl:my-4">
              Password
            </label>
            <input type="password"
              {...register("Password")}
