...
//     else if (window.innerWidth < 1280) setScreenSize('md') // lg & md combined
...
//                     // 6 dots for xs, 3 dots for sm, 2 dots for md and xl
//           const maxIndex = screenSize === 'xs' ? 5 : screenSize === 'sm' ? 2 :screenSize === "md" ? 1 : 1; 
//           // 2 dots for md and 1 for a xl
...
//   const visibleDestinations = result && result.length > 0 
//     ? screenSize === 'xs'
//       ? result.slice(currentIndex, currentIndex + 1)
//       : screenSize === 'sm'
//         ? result.slice(currentIndex *2, currentIndex  *2+ 2)
//       : screenSize === 'md'
//         ? result.slice(currentIndex *3, currentIndex *3+ 3)
//         : result.slice(currentIndex *4, currentIndex *4+ 4) // ✅ xl shows 4
//   : []
...
//             style={{ transform: `translateX(-${currentIndex * (screenSize === 'md' ? 100 / 3 : screenSize === 'sm' ? 50 : 100)}%)` }}
//           >
//             {result && result.length > 0 ? (
//               result.map((tour, i) => (
//                 <div 
//                   key={i} 
//                   className={`flex-shrink-0 ${screenSize === 'sm' ? 'w-1/2' : 'w-full sm:w-1/2 md:w-1/3'} px-1 sm:px-2 md:px-3 animate-slide-in`}
//                 >
...
//               ))
//             ) : (
//               <div className="w-full text-center py-10 sm:py-12">
...
//               {Array.from({ length: screenSize === 'xs' ? 6 : screenSize === 'sm' ? 3 :screenSize==="md"? 2:2}).map((_, i) => (
//                 <button
//                   key={i}
