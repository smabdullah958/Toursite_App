...
let GetByID=async(req,res)=>{
    try{
        ...
        .select(" ContactNumber WhatsAppNumber PickUpAddress  TravelTime TotalPrice PaymentMethod PaymentStatus Date NumberOfAdultChild NumberOfNoneAdultChild CarCapacity")
