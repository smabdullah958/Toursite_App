...
let SignUpAuth=require("../Features/Auth/SignUpAuth")
let validation=require("../Validator/AuthValidate")
let LogInAuth=require("../Features/Auth/LogInAuth")
let LogOut = require("../Features/Auth/LogOutAuth")
//it is used to check the user is login or not bro 
let CheckLogIn=require("../Features/Auth/CheckLogIn")
...
const ForgetPassword = require("../Features/Auth/ForgetPassword")
...
let ResetPassword = require("../Features/Auth/resetPassword")
